...
class HTTWeights : public ModuleBase {
 private:
  ...
  CLASS_MEMBER(HTTWeights, TH2D*, et_trigantiiso1_data)
  CLASS_MEMBER(HTTWeights, TH2D*, et_trigantiiso2_data)
  CLASS_MEMBER(HTTWeights, TH2D*, et_xtrig_mc)
  CLASS_MEMBER(HTTWeights, TH2D*, et_xtrig_data)
  CLASS_MEMBER(HTTWeights, TH2D*, et_xtrigantiiso1_data)
  CLASS_MEMBER(HTTWeights, TH2D*, et_xtrigantiiso2_data)
  ...
  CLASS_MEMBER(HTTWeights, TH2D*, mt_trigantiiso1_data)
  CLASS_MEMBER(HTTWeights, TH2D*, mt_trigantiiso2_data)
  CLASS_MEMBER(HTTWeights, TH2D*, mt_xtrig_mc)
  CLASS_MEMBER(HTTWeights, TH2D*, mt_xtrig_data)
  CLASS_MEMBER(HTTWeights, TH2D*, mt_xtrigantiiso1_data)
  CLASS_MEMBER(HTTWeights, TH2D*, mt_xtrigantiiso2_data)
